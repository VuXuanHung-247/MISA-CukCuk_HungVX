...
{
    public class BaseService<MISAEntity> : Interfaces.IService.IBaseRepository<MISAEntity> where MISAEntity : BaseEntity
    {
        #region Declare
        Interfaces.IRepository.IBaseRepository<MISAEntity> _baseRepository;
        ServiceResult _serviceResult;
        #endregion

        #region Constructor
        public BaseService(Interfaces.IRepository.IBaseRepository<MISAEntity> baseRepository)
        {
